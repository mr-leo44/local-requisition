        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <a @if (Session::get('authUser')->compte->role->value === 'user') href="{{ route('demandes.index') }}" 
                    ...
                    <img src="{{ asset('img/orange.png') }}" class="h-7 me-3" alt="Logo" />
                    <span
            ...
            <div class="flex justify-between items-center gap-3">
                <h3 class="text-gray-800 dark:text-white font-semibold sm:text-xs md:text-xl 2xl:text-lg">{{ Session::get('authUser')->name }}</h3>
                <div>
